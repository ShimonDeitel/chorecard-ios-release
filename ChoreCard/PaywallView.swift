...
struct PaywallView: View {
    ...
    private let benefits: [(String, String, String)] = [
        ("infinity", "Unlimited chores", "No weekly limit — assign as many chores as you like."),
        ("person.3.fill", "Multiple kids", "Add the whole family and rank everyone on the leaderboard."),
        ("gift.fill", "Custom rewards", "Create your own rewards with point costs that fit your family."),
        ("doc.text.fill", "Printable PDF summary", "A clean weekly recap you can print or save."),
        ("square.and.arrow.up.fill", "Share the week", "Send the leaderboard to family in a tap.")
    ]
            ...
            ScrollView {
                VStack(spacing: 22) {
                    VStack(spacing: 8) {
                        ...
                        Text("Chore Card Pro").font(.largeTitle.weight(.heavy))
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("Chore Card never tracks you. Your family's data stays private.")
